...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
        ...
        Title="Computer System Rename Tool" Height="300" Width="450" WindowStartupLocation="CenterScreen">
    <Grid>
        <Label x:Name="header" Content="Computer System Rename Tool" HorizontalAlignment="Left" Margin="10,0,0,0" VerticalAlignment="Top" Width="423" FontWeight="Bold" FontSize="14" HorizontalContentAlignment="Center"/>
