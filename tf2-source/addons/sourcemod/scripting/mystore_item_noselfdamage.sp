/*
 * MyStore - No self damage item module
 * by: shanapu
...
{
	name = "MyStore - No self damage item module",
...
{
	if (MyStore_RegisterHandler("noselfdamage", _, _, NoSelfDamage_Config, NoSelfDamage_Equip, NoSelfDamage_Remove, true) == -1)
	{
...
public bool NoSelfDamage_Config(KeyValues &kv, int itemid)
{
...
public int NoSelfDamage_Equip(int client, int itemid)
{
...
public int  NoSelfDamage_Remove(int client, int itemid)
{
