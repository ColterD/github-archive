...
{
	name = "MyStore - Grenade model item module",
...
{
	if (MyStore_RegisterHandler("grenademodel", GrenadeModels_OnMapStart, GrenadeModels_Reset, GrenadeModels_Config, GrenadeModels_Equip, GrenadeModels_Remove, true) == -1)
	{
