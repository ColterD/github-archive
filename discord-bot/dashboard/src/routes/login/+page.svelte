<script lang="ts">
  ...
  const errorMessages: Record<string, string> = {
    ...
    unauthorized: 'You are not authorized to access this dashboard. Only bot owners and admins can log in.',
  ...
  <div class="login-card">
    <Card>
      <div class="login-content">
        ...
        <p class="description">
          Manage your Discord bot's containers, GPU, and services.
        </p>
        ...
        <a href="/auth/discord" class="login-button">
        ...
        <p class="info">
          Only authorized users (bot owners and admins) can access this dashboard.
        </p>
      </div>
    </Card>
  </div>
